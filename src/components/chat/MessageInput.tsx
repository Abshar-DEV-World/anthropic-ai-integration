    ...
    <form onSubmit={handleSubmit} className="relative p-4 bg-card border-t border-border">
      <div className="relative max-w-4xl mx-auto">
        <textarea
          ...
          disabled={isLoading}
          className="w-full min-h-[80px] max-h-[200px] pl-4 pr-14 py-3.5 rounded-xl border border-input bg-muted/50 text-foreground resize-none focus:outline-none focus:ring-2 focus:ring-ring/20 focus:border-ring/50 focus:bg-background transition-all placeholder:text-muted-foreground text-[15px] font-normal shadow-sm"
          rows={3}
        />
        <button 
          type="submit" 
